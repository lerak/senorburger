    ...
    <div className=" flex flex-col min-h-screen font-sans text-gray-900 bg-gray-900">
      ...
      <footer className="border-t-4 border-yellow-500 bg-black ">
        ...
        <h3 className="font-bold text-white text-2xl">Contacto</h3>
            ...
            <button className="my-4 text-white bg-transparent font-semibold hover:text-white py-2 px-4 border border-white hover:border-transparent rounded"><a href="https://wa.me/529861129452"><FontAwesomeIcon icon={faWhatsapp} size="1x" /> Whatsapp</a></button>
          </div>
         <div className="grid grid-cols-1 md:grid-cols-4 gap-3 text-white self-center">
          ...
          <p>
            ...
            <ul className="text-gray-400 text-1xl">
              <li>Lunes 18:00 - 23:00</li>
              <li>Martes Cerrado</li>
              <li>Miercoles 18:00 - 23:00</li>
              <li>Jueves 18:00 - 23:00</li>
              <li>Viernes 15:00 - 23:00</li>
              <li>Sabado 15:00 - 23:00</li>
              <li>Domingo 15:00 - 23:00</li> 
            </ul>
          </p>
        </nav>
      </footer>
