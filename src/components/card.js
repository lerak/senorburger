    ...
    <div>
      <div className="z-1 overflow-visible flex items-stretch grid grid-cols-3 gap-10  text-white rounded p-5 m-5">
          ...
          <div className="c2 self-center ">
            <div className="">
              <h4 className="md:text-3xl  font-SyneMono text-white">Playa <span className="text-gray-400">Burger</span></h4>
            </div>
            <p className="text-yellow-500 text-1xl md:text-2xl">Carne con tocino, jitomate u queso</p>
          </div>
