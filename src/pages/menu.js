    ...
    <Layout>
      ...
      <div>
        <div>
          ...
          <Card image={burger} title="De La Casa" description="Carne con tocino, lechuga, jitomate, queso, champiñones y piña, acompañada de papas" price="95"/>
          <Card image={burger} title="Nohoch" description="Doble carne con tocino, lechuga, jitomate, queso y cebolla asada, acompañada de papas" price="110" />
          <Card image={burger} title="Selva" description="Carne con tocino, lechuga, jitomate, queso y guacamole" price="95" />
          <div>
